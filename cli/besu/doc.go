...
// Package besu provides header parsing, storage slot derivation and ABI
// encoding for Besu light-client payloads. Consensus verification belongs to
// the contract, simulated by the transaction submitter.
//
