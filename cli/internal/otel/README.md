...
| metric                   | type           | labels                                                                                  | notes                                                                                                    |
| ------------------------ | -------------- | --------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------- |
| `prover_operation_*`     | histogram (ms) | `operation`, `chain_id`, `client_id`, `type`, `result`; `proof_kind` on `packet_proofs` | `operation`: `latest_provable_height`, `client_update_payload`, `packet_proofs`. `type` is the client/prover type. |
