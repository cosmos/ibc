...
import (
	...
	"github.com/cosmos/ibc/cli/internal/store/repository/postgres"
)
...
func (db *PostgresDB) ListPacketSequencesFrom(
	...
	rows, err := db.repo.ListPacketSequencesFrom(ctx, postgres.ListPacketSequencesFromParams{
		ChainID:      chainID,
		ClientID:     clientID,
...
func (db *PostgresDB) GetClearingState(ctx context.Context, chainID string, clientID string) (ClearingState, error) {
...
func (db *PostgresDB) SetClearingState(
	ctx context.Context,
	chainID string,
	clientID string,
	lastProbed uint64,
	...
	return db.repo.SetClearingState(ctx, postgres.SetClearingStateParams{
		ChainID:            chainID,
		ClientID:           clientID,
