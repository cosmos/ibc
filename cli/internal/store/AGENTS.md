...
✔︎ Created /path/to/ibc/cli/internal/store/migrations/sqlite/002-add-packet-index.sql
✔︎ Created /path/to/ibc/cli/internal/store/migrations/postgres/002-add-packet-index.sql
```
...
- (re)generate bindings with `just cli::codegen-sql`.
