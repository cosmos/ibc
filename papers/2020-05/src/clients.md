...
with which an actor can do so. The client abstraction formalises this model's interface & requirements,
...
— from the perspective of IBC, a chain is defined entirely by its light client validation & equivocation detection logic.
...
previously valid commitment roots & preventing future updates. What precisely constitutes misbehaviour will
