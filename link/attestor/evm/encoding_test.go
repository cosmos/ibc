...
func TestAttestationProofEncode(t *testing.T) {
	// Generated by Solidity 0.8.30 from IAttestationMsgs.AttestationProof at
	// solidity-ibc-eureka commit 39904319467b5fbdec8c34c43b66af6f1d256dba:
	// abi.encode(AttestationProof(hex"010203", [hex"0405", hex"06"])).
