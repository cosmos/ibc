...
// MockRelayerApiServiceClient_Status_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'Status'
type MockRelayerApiServiceClient_Status_Call struct {
	*mock.Call
}
