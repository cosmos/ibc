...
type ConnectionConfig struct {
	...
	ClientA ClientEndConfig `yaml:"clientA"`
	ClientB ClientEndConfig `yaml:"clientB"`
}

// ClientEndConfig one side of a connection: a light client on chainId,
// tracking the connection's other end as its counterparty.
type ClientEndConfig struct {
	ChainID  string     `yaml:"chainId"`
...
// connection.
func (c RelayerConfig) ClientEnd(chainID, clientID string) (end, counterparty ClientEndConfig, ok bool) {
	...
	return ClientEndConfig{}, ClientEndConfig{}, false
}
...
func (c ClientEndConfig) Validate() error {
	switch {
	case c.ChainID == "":
