...
func (p *blockingBatchProcessor) ShouldProcess(*processors.Transfer) bool { return true }
...
func (p *blockingBatchProcessor) Cancel([]*processors.Transfer, error) {}
