module github.com/cosmos/ibc/link/e2e

go 1.26.4

require (
	github.com/cosmos/ibc/link v0.0.0
	github.com/cosmos/ibc/link/harness v0.0.0-00010101000000-000000000000
...
replace github.com/cosmos/ibc/link/harness => ../harness

replace github.com/cosmos/ibc/link => ../
