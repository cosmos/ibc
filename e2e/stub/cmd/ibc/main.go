...
import (
	...
	"github.com/cosmos/ibc/e2e/stub/internal/relay"
	"github.com/cosmos/ibc/e2e/stub/internal/testappdeploy"
	"github.com/cosmos/ibc/e2e/stub/internal/validate"
)

var globalFlags = cfg.DefaultFlagSet()
...
func newRoot() *cobra.Command {
	...
	cfg.DeclarePersistentFlags(root, &globalFlags)
