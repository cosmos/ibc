...
replace (
	...
	github.com/cosmos/solidity-ibc-eureka/packages/go-abigen => github.com/cosmos/ibc-contracts/packages/go-abigen v0.0.0-20260917161050-aafbb70223e2
	// Matches link: the prover service pulls in link's signer package, which
	// needs this cometbft.
