...
Each `tokenId` has a corresponding entry in `tokenData` which, if present, contains some opaque application data associated with the token (e.g., royalty parameters).
