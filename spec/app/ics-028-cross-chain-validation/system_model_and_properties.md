...
Nonetheless, as a **requirement of CCV**, *all the updates to validator power on the provider chain MUST be included in the sequence of updates to validator power on all consumer chains*.
