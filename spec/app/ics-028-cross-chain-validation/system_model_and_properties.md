...
Nonetheless, as a **requirement of CCV**, *all the validator sets on all the consumer chains MUST be included in the sequence of validator sets on the provider chain*.
